...
```
<script src="https://cdn.jsdelivr.net/gh/oleteacher/Qik-Exit-Intent-Popup@main/js/bioep.min.js"></script>
```
...
bioEp.init({
	html: '<div id="bio_ep_content">' +
		'<img src="https://i.postimg.cc/q7FdVCp2/tag.png" alt="Claim your discount!" />' +
		'<span>HOLD ON!</span>' +
